export default function AboutPage() {
  return (
    <main className="max-w-6xl mx-auto px-4 py-8">
      <div className="border border-zinc-700/70 bg-zinc-900/50 rounded-2xl overflow-hidden">
        {/* Terminal Header */}
        ...
        <div className="p-8 font-mono text-sm">
          ...
          <div className="mb-8 leading-relaxed">
            <p className="mb-4 text-white font-medium text-base">
              ...
              digital experiences that make a difference. I work with modern
              technologies to build scalable web applications and beautiful user
              interfaces.
            </p>
            <p className="mb-4 text-white font-medium text-base">
          ...
          <div className="border-t border-zinc-700 pt-8">
            <div className="mb-6">
              <span className="text-zinc-500 text-xs">
                musabbir@portfolio:~$ ls -la skills/
              </span>
            </div>
          ...
          <div className="border-t border-zinc-700 pt-8 mt-8">
            <div className="mb-6">
              <span className="text-zinc-500 text-xs">
                musabbir@portfolio:~$ cat experience.txt
              </span>
            </div>
            ...
            <div className="space-y-4 text-zinc-300">
              <div className="border border-zinc-700 p-6">
                ...
                <p className="mt-3">
                  Full-stack developer working on web applications and digital
                  solutions.
                </p>
              </div>
            </div>
